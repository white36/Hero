...
#define YAW_GYRO_ABSOLUTE_PID_KF 0.0f
#define YAW_GYRO_ABSOLUTE_PID_MAX_IOUT 0.0f
#define YAW_GYRO_ABSOLUTE_PID_MAX_OUT 10.0f

// yaw 角速度环 PID参数
#define YAW_Omega_PID_KP 2000.0f
#define YAW_Omega_PID_KI 5.0f
#define YAW_Omega_PID_KD 0.0f
#define YAW_Omega_PID_KF 0.0f
#define YAW_Omega_PID_MAX_IOUT 10000.0f
#define YAW_Omega_PID_MAX_OUT 20000.0f

// yaw 力矩环 PID参数
#define YAW_Torque_PID_KP 500.0f
#define YAW_Torque_PID_KI 0.0f
#define YAW_Torque_PID_KD 0.0f
#define YAW_Torque_PID_KF 0.0f
#define YAW_Torque_PID_MAX_IOUT 8000.0f
#define YAW_Torque_PID_MAX_OUT 10000.0f
...
#define PITCH_GYRO_ABSOLUTE_PID_KF 0.0f
#define PITCH_GYRO_ABSOLUTE_PID_MAX_IOUT 0.0f
#define PITCH_GYRO_ABSOLUTE_PID_MAX_OUT 10.0f

// PITCH 角速度环 PID参数
#define PITCH_Omega_PID_KP 500.0f
#define PITCH_Omega_PID_KI 0.0f
#define PITCH_Omega_PID_KD 0.0f
#define PITCH_Omega_PID_KF 0.0f
#define PITCH_Omega_PID_MAX_IOUT 8000.0f
#define PITCH_Omega_PID_MAX_OUT 10000.0f

// // PITCH 力矩环 PID参数
// #define PITCH_Torque_PID_KP 500.0f
// #define PITCH_Torque_PID_KI 0.0f
// #define PITCH_Torque_PID_KD 0.0f
// #define PITCH_Torque_PID_KF 0.0f
// #define PITCH_Torque_PID_MAX_IOUT 8000.0f
// #define PITCH_Torque_PID_MAX_OUT 10000.0f

/***************************************************************** 其他参数 *******************************************************************/

// yaw 角度环 角度由陀螺仪解算 PID参数
#define YAW_GYRO_ABSOLUTE_PID_DEAD_ZONE 0.5f
#define YAW_GYRO_ABSOLUTE_I_Variable_Speed_A 0.0f
#define YAW_GYRO_ABSOLUTE_I_Variable_Speed_B 0.0f
#define YAW_GYRO_ABSOLUTE_I_Separate_Threshold 0.0f
// yaw 角速度环 PID参数
#define YAW_Omega_PID_DEAD_ZONE 0.5f
#define YAW_Omega_I_Variable_Speed_A 0.0f
#define YAW_Omega_I_Variable_Speed_B 0.0f
#define YAW_Omega_I_Separate_Threshold 0.0f
// yaw 力矩环 PID参数
#define YAW_Torque_PID_DEAD_ZONE 0.5f
#define YAW_Torque_I_Variable_Speed_A 0.0f
#define YAW_Torque_I_Variable_Speed_B 0.0f
#define YAW_Torque_I_Separate_Threshold 0.0f


// PITCH 角度环 角度由陀螺仪解算 PID参数
#define PITCH_GYRO_ABSOLUTE_PID_DEAD_ZONE 0.5f
#define PITCH_GYRO_ABSOLUTE_I_Variable_Speed_A 0.0f
#define PITCH_GYRO_ABSOLUTE_I_Variable_Speed_B 0.0f
#define PITCH_GYRO_ABSOLUTE_I_Separate_Threshold 0.0f
// PITCH 角速度环 PID参数
#define PITCH_Omega_PID_DEAD_ZONE 0.5f
#define PITCH_Omega_I_Variable_Speed_A 0.0f
#define PITCH_Omega_I_Variable_Speed_B 0.0f
#define PITCH_Omega_I_Separate_Threshold 0.0f
// // PITCH 力矩环 PID参数
// #define PITCH_Torque_PID_DEAD_ZONE 0.5f
// #define PITCH_Torque_I_Variable_Speed_A 0.0f
// #define PITCH_Torque_I_Variable_Speed_B 0.0f
// #define PITCH_Torque_I_Separate_Threshold 0.0f
...
typedef struct
{
    ...
    // 电机通信及pid结构体
    Motor_GM6020 Motor_GM6020;
    Motor_C620 Motor_C620;
