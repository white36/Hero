...
//最小设定弹速
#define MIN_SET_BULLET_SPEED 10.0f
//最大设定弹速
#define MAX_SET_BULLET_SPEED 18.0f
//初始设定弹速
#define BEGIN_SET_BULLET_SPEED 25.0f

//空气阻力系数
#define AIR_K1 0.06f//0.40f//0.36f
//初始子弹飞行迭代数值
#define T_0 0.0f
//迭代精度
...
// 击打敌方机器人0.1
//imu到枪口的竖直距离
#define Z_STATIC -0.0654f//0.136f//dm
//枪口前推距离
#define DISTANCE_STATIC 0.10793f//dm
//初始飞行时间
